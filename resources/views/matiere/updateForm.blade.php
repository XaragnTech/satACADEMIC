    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('matiere.update',$matiere) }}">
                        @csrf
                        <div class="form-group row">
                            <label for="libele" class="col-md-4 col-form-label text-md-right">{{ __('Nom de la Matiere') }}</label>

                            <div class="col-md-6">
                                <input id="libele" type="text" class="form-control @error('libele') is-invalid @enderror" name="libele" value="{{ $matiere->libele}}" required autocomplete="libele" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="inputState" class="form-control" name = "semestre">
                                    @if ($matiere->semestre == "Semestre 1")
